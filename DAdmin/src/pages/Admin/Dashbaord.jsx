...
//   return (
//     <div className="w-full p-6 bg-gradient-to-r from-gray-700 to-gray-800 text-white min-h-screen">
...
//       {/* Appointment  Chart */}
//       <motion.div
//         className="w-[50%] bg-gray-900 bg-opacity-100 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-8"
...
//       <div className="bg-gray-800 text-white rounded-xl shadow-sm overflow-hidden">
...
//             {/* Table Header */}
//             <div className="grid grid-cols-5 px-6 py-3 bg-green-600 text-white-900 font-medium text-medium">
//               <div>Date</div>
//               <div>Time</div>
//               <div>Patient</div>
//               <div>Doctor</div>
...
//               <div key={appointment._id} className="grid grid-cols-5 text-white px-6 py-4 border-b border-gray-100 ">
//                 <div className="text-white-900">{formatDate(appointment.slotDate)}</div>
//                 <div className="text-white-900">{appointment.slotTime}</div>
//                 <div className="text-white-900">{appointment.userName}</div>
//                 <div className="text-white-900">{appointment.doctorName}</div>
//                 <div>
//                   <button
  ...
  return (
    <div className="w-full p-6 bg-gradient-to-r from-gray-700 to-gray-800 text-white min-h-screen">
      ...
      <div className="flex gap-6 w-full mb-8">
        {/* Appointment Chart */}
        <motion.div
          className="w-[50%] bg-gray-900 bg-opacity-100 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.2 }}
        >
        ...
        >
          <div className="w-full">
            <h2 className="text-xl font-semibold text-gray-100 mb-4">Appointment by Types(Field )</h2>
