...
//       } else {
//         setModalMessage('Failed to load appointments.');
//         setShowModal(true);
//       }
//     } catch (error) {
...
//               here
//             </span>{' '}
//             to find doctors for an appointment.
//           </p>
//         </div>
//       ) : (
//         <div className="space-y-8">
//           {appointments.map((item, index) => (
//             <div key={index} className="flex flex-col md:flex-row gap-6 p-4 bg-white rounded-lg shadow-md border border-gray-200">
//               <div className="flex-shrink-0">
//                 {item.docData?.image ? (
//                   <img src={item.docData.image} alt="Doctor" className="w-28 h-28 object-cover rounded-full shadow-lg" />
//                 ) : (
...
//                 <p className="text-xl font-bold text-gray-800">{item.docData?.name || 'Doctor name not available'}</p>
//                 <p className="text-gray-600 text-sm">{item.docData?.speciality || 'Speciality not available'}</p>
//                 <div className="mt-4">
...
//                 {!item.cancelled && (
//                   <button className="py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition-all">
//                     Pay Online
//                   </button>
//                 )}
//                 {!item.cancelled && (
...
//             <p className="text-lg font-semibold text-red-600">{modalMessage}</p>
//             <button onClick={() => setShowModal(false)} className="mt-4 py-2 px-4 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600">
//               OK
//             </button>
//           </div>
//         </div>
...
const MyAppointments = () => {
  ...
  //                   className={`mx-1 p-2 ${rating >= num ? 'text-yellow-500' : 'text-gray-400'}`}
  //                 >
  //                   ★
  //                 </button>
  //               ))}
  ...
  //                 className="mt-2 py-2 px-4 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600"
  //               >
  //                 Submit
  //               </button>
  //             </div>
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                    ...
                    <span
                      className={`mt-2 md:mt-0 px-3 py-1 rounded-full text-sm font-medium ${
                        item.cancelled ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'
                      }`}
                    >
